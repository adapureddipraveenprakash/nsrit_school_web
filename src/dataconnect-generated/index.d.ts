...
export function transferStudent(vars: TransferStudentVariables): MutationPromise<TransferStudentData, TransferStudentVariables>;
export function transferStudent(dc: DataConnect, vars: TransferStudentVariables): MutationPromise<TransferStudentData, TransferStudentVariables>;
...
export function getNotice(vars: GetNoticeVariables, options?: ExecuteQueryOptions): QueryPromise<GetNoticeData, GetNoticeVariables>;
export function getNotice(dc: DataConnect, vars: GetNoticeVariables, options?: ExecuteQueryOptions): QueryPromise<GetNoticeData, GetNoticeVariables>;
