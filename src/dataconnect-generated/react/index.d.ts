...
export function useUpdateCoordinator(options?: useDataConnectMutationOptions<UpdateCoordinatorData, FirebaseError, UpdateCoordinatorVariables>): UseDataConnectMutationResult<UpdateCoordinatorData, UpdateCoordinatorVariables>;
export function useUpdateCoordinator(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateCoordinatorData, FirebaseError, UpdateCoordinatorVariables>): UseDataConnectMutationResult<UpdateCoordinatorData, UpdateCoordinatorVariables>;

export function useMigrateReceiptNumber(options?: useDataConnectMutationOptions<MigrateReceiptNumberData, FirebaseError, MigrateReceiptNumberVariables>): UseDataConnectMutationResult<MigrateReceiptNumberData, MigrateReceiptNumberVariables>;
export function useMigrateReceiptNumber(dc: DataConnect, options?: useDataConnectMutationOptions<MigrateReceiptNumberData, FirebaseError, MigrateReceiptNumberVariables>): UseDataConnectMutationResult<MigrateReceiptNumberData, MigrateReceiptNumberVariables>;

export function useUpsertReceiptSequence(options?: useDataConnectMutationOptions<UpsertReceiptSequenceData, FirebaseError, UpsertReceiptSequenceVariables>): UseDataConnectMutationResult<UpsertReceiptSequenceData, UpsertReceiptSequenceVariables>;
export function useUpsertReceiptSequence(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertReceiptSequenceData, FirebaseError, UpsertReceiptSequenceVariables>): UseDataConnectMutationResult<UpsertReceiptSequenceData, UpsertReceiptSequenceVariables>;
