...
const StudentFeeProfile = () => {
  ...
  const getReceiptHtml = (payment) => {
    ...
    const className = studentDetails?.academicClass?.name || 'N/A';
    ...
    const receivedBy = payment.collectedBy?.fullName || 'B. Geetha';
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => navigate(`/settings/collection?studentId=${studentId}`)}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-slate-500 font-extrabold uppercase tracking-wide">
                        {p.remarks || p.installment || 'School Fee'} · {p.paymentMode} {isReversed ? '(Reversed)' : ''}
                      </p>
